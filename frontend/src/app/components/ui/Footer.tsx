      ...
      <div className="container mx-auto py-10 px-4 lg:w-[76%]">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li><Link href="/#vegetable" className="hover:text-green-600">Vegetables</Link></li>
              <li><Link href="/#fruit" className="hover:text-green-600">Fruits</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-10 pt-6 border-t border-gray-200 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} VeggieKart Commerce. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
